...
- [`mythoside-core`](https://github.com/Mythos-IDE/mythoside-core) — Tauri + TypeScript ile geliştirilen masaüstü uygulaması. [FSL-1.1-ALv2](https://github.com/Mythos-IDE/mythoside-core/blob/main/LICENSE.md) kapsamında kaynak kodları erişilebilirdir.

## Durum

Erken geliştirme aşaması. Gelişmeleri takip etmek, projeye yıldız vermek veya kurgu süreçlerinize uygun şekilde şekillenmesinde söz sahibi olmak için [Discussions](https://github.com/Mythos-IDE/mythoside-core/discussions) sekmesine katılabilirsiniz.

## İletişim

- Sorunlar ve özellik fikirleri → repo [Issues](https://github.com/Mythos-IDE/mythoside-core/issues)
- Genel sorular → repo [Discussions](https://github.com/Mythos-IDE/mythoside-core/discussions)
